...
#     model_uri="models:/ARM Model 1@workingwell"
# )

# from src.entity.config_entity import DataIngestionConfig, FeatureExtractionConfig, ModelsaveConfig, MetricsaveConfig
# print(FeatureExtractionConfig.feature_store_file_path)

# import numpy as np 
# image = np.load(FeatureExtractionConfig.feature_store_file_path)
